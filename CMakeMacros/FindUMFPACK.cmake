...
FIND_PATH(UMFPACK_INCLUDE_DIR umfpack.h /usr/include /usr/local/include /usr/include/umfpack /usr/local/include/UMFPACK /usr/include/suitesparse /opt/local/include/ufsparse)
FIND_PATH(AMD_INCLUDE_DIR     amd.h     /usr/include /usr/local/include /usr/local/include/AMD /usr/include/suitesparse /opt/local/include/ufsparse)
...
FIND_LIBRARY(COLAMD_LIBRARY  NAMES libcolamd colamd    PATHS ${MY_UMFPACK_LIB_DIRS}  NO_DEFAULT_PATH)
FIND_LIBRARY(CHOLMOD_LIBRARY NAMES libcholmod cholmod  PATHS ${MY_UMFPACK_LIB_DIRS}  NO_DEFAULT_PATH)
...
FIND_LIBRARY(COLAMD_LIBRARY  NAMES libcolamd colamd    PATHS /usr/lib /usr/local/lib/)
FIND_LIBRARY(CHOLMOD_LIBRARY NAMES libcholmod cholmod  PATHS /usr/lib /usr/local/lib/)
...
SET(UMFPACK_LIBRARIES     ${UMFPACK_LIBRARY} ${SSC_LIBRARY} ${AMD_LIBRARY} ${COLAMD_LIBRARY} ${CHOLMOD_LIBRARY})
